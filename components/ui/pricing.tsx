...
function InteractiveStarfield({
  ...
  // Star positions are random, so this is client-only: rendering them during
  // SSR would produce one random layout on the server and a different one on
  // the client, hydrating with a mismatch on every star.
