...
// Demo data — not wired into any route. Onchain Battle Cards has no plans,
// tiers or paid features; this file exists only so the installed component
// has a working usage example to reference if a real need for it ever comes up.
const demoPlans = [
  {
    name: "Starter",
    price: "50",
